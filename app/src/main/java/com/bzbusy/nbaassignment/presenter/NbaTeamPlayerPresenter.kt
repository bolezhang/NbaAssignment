...
import com.bzbusy.nbaassignment.TeamDetailActivity
import com.bzbusy.nbaassignment.model.Player
import java.util.*

class NbaTeamPlayerPresenter(private val mView: TeamDetailActivity, private val mPlayers: ArrayList<Player>) {
    fun loadData() {
